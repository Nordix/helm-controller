...
This is an EST patch release to drop back https://github.com/fluxcd/helm-controller/pull/1369 and resolve CVE-2026-35206

Fixes:
- Update helm to remediate CVE-2026-35206
 [#2] https://github.com/Nordix/helm-controller/pull/2
- Remove stale released state when configuration set back to current state
 [#1](https://github.com/Nordix/helm-controller/pull/1)
